...
int main() {
    ...
    **pp = 200;
    ...
    // ==================== CATEGORY: OOP - INHERITANCE & POLYMORPHISM ====================

    // OOP 1: Simple Single Inheritance with Constructor Chain
    {
        id: 'oop-single-inheritance',
        title: 'Single Inheritance: Constructor Chain',
        description: 'Base class constructor called BEFORE derived class constructor',
        difficulty: 'INTERMEDIATE',
...
int main() {
    Dog d;
        ...
        steps: [
            { id: 1, phase: 'CLASS_DEF', line: 1, charStart: 0, charEnd: 12, highlight: 'class Animal', description: 'Define base class: Animal', variables: {} },
            { id: 2, phase: 'CONSTRUCTOR', line: 3, charStart: 4, charEnd: 11, highlight: 'Animal()', description: 'Animal has a constructor that prints "Animal"', variables: {} },
            { id: 3, phase: 'CLASS_DEF', line: 6, charStart: 0, charEnd: 25, highlight: 'class Dog : public Animal', description: 'Dog INHERITS from Animal (public inheritance)', variables: {} },
            { id: 4, phase: 'CONSTRUCTOR', line: 8, charStart: 4, charEnd: 8, highlight: 'Dog()', description: 'Dog constructor prints "Dog"', variables: {} },
            { id: 5, phase: 'MAIN', line: 11, charStart: 0, charEnd: 10, highlight: 'int main()', description: 'Program entry point', variables: {} },
            { id: 6, phase: 'CREATE_OBJ', line: 12, charStart: 4, charEnd: 9, highlight: 'Dog d', description: '⚡ Create Dog object - triggers constructor chain!', variables: { d: 'Dog object' } },
            { id: 7, phase: 'BASE_CTOR', line: 3, charStart: 4, charEnd: 38, highlight: 'Animal() { cout << "Animal "; }', description: '1️⃣ FIRST: Base class (Animal) constructor runs', variables: { d: 'Dog object' }, output: 'Animal ' },
            { id: 8, phase: 'DERIVED_CTOR', line: 8, charStart: 4, charEnd: 35, highlight: 'Dog() { cout << "Dog "; }', description: '2️⃣ SECOND: Derived class (Dog) constructor runs', variables: { d: 'Dog object' }, output: 'Animal Dog ' },
            { id: 9, phase: 'COMPLETE', line: 13, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Constructor order: Base → Derived (always!)', variables: { d: 'Dog object' }, output: 'Animal Dog ' }
        ]
    },

    // OOP 2: Multi-Level Inheritance (3 levels)
    {
        id: 'oop-multilevel-inheritance',
        title: 'Multi-Level Inheritance: 3-Level Chain',
        description: 'Grandparent → Parent → Child constructor order',
        difficulty: 'ADVANCED',
        category: 'OOP Inheritance',
...
int main() {
    Child c;
        ...
        expectedOutput: 'GP P C ',
        steps: [
            { id: 1, phase: 'HIERARCHY', line: 1, charStart: 0, charEnd: 17, highlight: 'class Grandparent', description: 'Level 1: Grandparent (top of hierarchy)', variables: {} },
            { id: 2, phase: 'HIERARCHY', line: 6, charStart: 0, charEnd: 31, highlight: 'class Parent : public Grandparent', description: 'Level 2: Parent extends Grandparent', variables: {} },
            { id: 3, phase: 'HIERARCHY', line: 11, charStart: 0, charEnd: 26, highlight: 'class Child : public Parent', description: 'Level 3: Child extends Parent', variables: {} },
            { id: 4, phase: 'CREATE_OBJ', line: 17, charStart: 4, charEnd: 11, highlight: 'Child c', description: '⚡ Create Child - triggers 3-level constructor chain!', variables: { c: 'Child object' } },
            { id: 5, phase: 'CTOR_1', line: 3, charStart: 4, charEnd: 37, highlight: 'Grandparent() { cout << "GP "; }', description: '1️⃣ FIRST: Grandparent constructor (oldest ancestor)', variables: {}, output: 'GP ' },
            { id: 6, phase: 'CTOR_2', line: 8, charStart: 4, charEnd: 32, highlight: 'Parent() { cout << "P "; }', description: '2️⃣ SECOND: Parent constructor', variables: {}, output: 'GP P ' },
            { id: 7, phase: 'CTOR_3', line: 13, charStart: 4, charEnd: 31, highlight: 'Child() { cout << "C "; }', description: '3️⃣ THIRD: Child constructor (most derived)', variables: {}, output: 'GP P C ' },
            { id: 8, phase: 'COMPLETE', line: 18, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Order: Grandparent → Parent → Child (top to bottom)', variables: { c: 'Child object' }, output: 'GP P C ' }
        ]
    },

    // OOP 3: Constructor with Parameters
    {
        id: 'oop-parameterized-ctors',
        title: 'Parameterized Constructors: Initializer List',
        description: 'Passing arguments to base class constructor using initializer list',
        difficulty: 'ADVANCED',
        category: 'OOP Inheritance',
        code: `class Shape {
protected:
    int sides;
public:
    Shape(int s) : sides(s) { cout << sides << "S "; }
};

class Triangle : public Shape {
public:
    Triangle() : Shape(3) { cout << "Tri "; }
};

int main() {
    Triangle t;
}`,
        expectedOutput: '3S Tri ',
        steps: [
            { id: 1, phase: 'CLASS_DEF', line: 1, charStart: 0, charEnd: 11, highlight: 'class Shape', description: 'Base class Shape with protected member', variables: {} },
            { id: 2, phase: 'PROTECTED', line: 3, charStart: 4, charEnd: 14, highlight: 'int sides;', description: 'Protected: accessible by derived classes', variables: {} },
            { id: 3, phase: 'CTOR_PARAM', line: 5, charStart: 4, charEnd: 14, highlight: 'Shape(int s)', description: 'Parameterized constructor takes int', variables: {} },
            { id: 4, phase: 'INIT_LIST', line: 5, charStart: 17, charEnd: 25, highlight: 'sides(s)', description: 'Initializer list: sides = s', variables: {} },
            { id: 5, phase: 'DERIVED_CTOR', line: 10, charStart: 4, charEnd: 16, highlight: 'Triangle()', description: 'Triangle default constructor', variables: {} },
            { id: 6, phase: 'CALL_BASE', line: 10, charStart: 19, charEnd: 27, highlight: 'Shape(3)', description: '⚡ Call base constructor with argument 3', variables: {} },
            { id: 7, phase: 'CREATE_OBJ', line: 14, charStart: 4, charEnd: 15, highlight: 'Triangle t', description: 'Create Triangle object', variables: { t: 'Triangle' } },
            { id: 8, phase: 'BASE_RUNS', line: 5, charStart: 27, charEnd: 45, highlight: 'cout << sides << "S "', description: '1️⃣ Shape(3) runs: sides=3, output "3S"', variables: { sides: 3 }, output: '3S ' },
            { id: 9, phase: 'DERIVED_RUNS', line: 10, charStart: 30, charEnd: 43, highlight: 'cout << "Tri "', description: '2️⃣ Triangle constructor body runs', variables: { sides: 3 }, output: '3S Tri ' },
            { id: 10, phase: 'COMPLETE', line: 15, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Initializer list passes args to base constructor', variables: {}, output: '3S Tri ' }
        ]
    },

    // OOP 4: Destructor Chain (Reverse Order)
    {
        id: 'oop-destructors',
        title: 'Destructors: Reverse Order',
        description: 'Destructors called in REVERSE order: Derived → Base',
        difficulty: 'ADVANCED',
        category: 'OOP Inheritance',
        code: `class Base {
public:
...
int main() {
    ...
    delete d;
        ...
        expectedOutput: 'B+ D+ D- B- ',
        steps: [
            { id: 1, phase: 'CLASS_DEF', line: 1, charStart: 0, charEnd: 10, highlight: 'class Base', description: 'Base class with constructor and destructor', variables: {} },
            { id: 2, phase: 'CTOR', line: 3, charStart: 4, charEnd: 29, highlight: 'Base() { cout << "B+ "; }', description: 'Constructor prints "B+"', variables: {} },
            { id: 3, phase: 'DTOR', line: 4, charStart: 4, charEnd: 30, highlight: '~Base() { cout << "B- "; }', description: 'Destructor prints "B-" (note the ~)', variables: {} },
            { id: 4, phase: 'DERIVED_DEF', line: 7, charStart: 0, charEnd: 26, highlight: 'class Derived : public Base', description: 'Derived inherits from Base', variables: {} },
            { id: 5, phase: 'CREATE', line: 14, charStart: 4, charEnd: 31, highlight: 'Derived* d = new Derived()', description: '⚡ Allocate Derived object on heap', variables: { d: 'pointer' } },
            { id: 6, phase: 'BASE_CTOR', line: 3, charStart: 4, charEnd: 29, highlight: 'Base() { cout << "B+ "; }', description: '1️⃣ Base constructor runs first', variables: {}, output: 'B+ ' },
            { id: 7, phase: 'DERIVED_CTOR', line: 9, charStart: 4, charEnd: 32, highlight: 'Derived() { cout << "D+ "; }', description: '2️⃣ Derived constructor runs second', variables: {}, output: 'B+ D+ ' },
            { id: 8, phase: 'DELETE', line: 15, charStart: 4, charEnd: 13, highlight: 'delete d;', description: '🗑️ Delete triggers destructor chain', variables: {} },
            { id: 9, phase: 'DERIVED_DTOR', line: 10, charStart: 4, charEnd: 33, highlight: '~Derived() { cout << "D- "; }', description: '3️⃣ Derived destructor runs FIRST (reverse!)', variables: {}, output: 'B+ D+ D- ' },
            { id: 10, phase: 'BASE_DTOR', line: 4, charStart: 4, charEnd: 30, highlight: '~Base() { cout << "B- "; }', description: '4️⃣ Base destructor runs LAST', variables: {}, output: 'B+ D+ D- B- ' },
            { id: 11, phase: 'COMPLETE', line: 16, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Constructor: Base→Derived | Destructor: Derived→Base', variables: {}, output: 'B+ D+ D- B- ' }
        ]
    },

    // OOP 5: Virtual Function & Runtime Polymorphism
    {
        id: 'oop-virtual-polymorphism',
        title: 'Virtual Functions: Runtime Polymorphism',
        description: 'Base pointer to derived object calls DERIVED method',
        difficulty: 'ADVANCED',
...
int main() {
    ...
    a->speak();
        ...
        expectedOutput: 'Meow',
        steps: [
            { id: 1, phase: 'VIRTUAL_DEF', line: 3, charStart: 4, charEnd: 11, highlight: 'virtual', description: '⭐ VIRTUAL keyword enables runtime polymorphism', variables: {} },
            { id: 2, phase: 'BASE_METHOD', line: 3, charStart: 12, charEnd: 24, highlight: 'void speak()', description: 'Base class speak() - can be overridden', variables: {} },
            { id: 3, phase: 'OVERRIDE', line: 8, charStart: 4, charEnd: 26, highlight: 'void speak() override', description: 'Cat OVERRIDES speak() with its own version', variables: {} },
            { id: 4, phase: 'POINTER_DECL', line: 12, charStart: 4, charEnd: 12, highlight: 'Animal* a', description: 'Pointer type is Animal (base class)', variables: { a: 'Animal*' } },
            { id: 5, phase: 'OBJ_CREATE', line: 12, charStart: 15, charEnd: 25, highlight: 'new Cat()', description: 'But actual object is Cat (derived class)!', variables: { a: 'Animal* → Cat' } },
            { id: 6, phase: 'CALL', line: 13, charStart: 4, charEnd: 14, highlight: 'a->speak()', description: '🎯 Call speak() on Animal pointer...', variables: { a: 'Animal* → Cat' } },
            { id: 7, phase: 'VIRTUAL_LOOKUP', line: 8, charStart: 4, charEnd: 44, highlight: 'void speak() override { cout << "Meow"; }', description: '⚡ VTABLE lookup → finds Cat::speak() because virtual!', variables: {} },
            { id: 8, phase: 'EXECUTE', line: 8, charStart: 28, charEnd: 40, highlight: 'cout << "Meow"', description: 'Cat version executes: "Meow"', variables: {}, output: 'Meow' },
            { id: 9, phase: 'COMPLETE', line: 14, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Polymorphism: pointer type ≠ runtime behavior', variables: {}, output: 'Meow' }
        ]
    },

    // OOP 6: Without Virtual (Static Binding)
    {
        id: 'oop-no-virtual',
        title: 'Without Virtual: Static Binding',
        description: 'Without virtual, base method is called (compile-time decision)',
        difficulty: 'ADVANCED',
        category: 'OOP Polymorphism',
        code: `class Animal {
public:
...
int main() {
    ...
    a->speak();
        ...
        expectedOutput: '?',
        steps: [
            { id: 1, phase: 'NO_VIRTUAL', line: 3, charStart: 4, charEnd: 16, highlight: 'void speak()', description: '❌ NO virtual keyword - static binding!', variables: {} },
            { id: 2, phase: 'DERIVED_DEF', line: 8, charStart: 4, charEnd: 16, highlight: 'void speak()', description: 'Cat also has speak() but it HIDES, not overrides', variables: {} },
            { id: 3, phase: 'POINTER', line: 12, charStart: 4, charEnd: 12, highlight: 'Animal* a', description: 'Pointer type is Animal', variables: { a: 'Animal*' } },
            { id: 4, phase: 'OBJECT', line: 12, charStart: 15, charEnd: 25, highlight: 'new Cat()', description: 'Actual object is Cat', variables: { a: 'Animal* → Cat' } },
            { id: 5, phase: 'CALL', line: 13, charStart: 4, charEnd: 14, highlight: 'a->speak()', description: '🎯 Call speak() on Animal pointer...', variables: {} },
            { id: 6, phase: 'STATIC_BIND', line: 3, charStart: 4, charEnd: 32, highlight: 'void speak() { cout << "?"; }', description: '⚠️ Compiler uses POINTER TYPE (Animal) - no virtual table!', variables: {} },
            { id: 7, phase: 'EXECUTE', line: 3, charStart: 19, charEnd: 27, highlight: 'cout << "?"', description: 'Animal version executes: "?"', variables: {}, output: '?' },
            { id: 8, phase: 'COMPLETE', line: 14, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Without virtual: method bound at COMPILE time by pointer type', variables: {}, output: '?' }
        ]
    },

    // OOP 7: Pure Virtual (Abstract Class)
    {
        id: 'oop-pure-virtual',
        title: 'Abstract Class: Pure Virtual Function',
        description: 'Pure virtual = 0 makes class abstract (cannot instantiate)',
        difficulty: 'ADVANCED',
        category: 'OOP Polymorphism',
        code: `class Shape {
public:
...
int main() {
    ...
    cout << s->area();
        ...
        steps: [
            { id: 1, phase: 'PURE_VIRTUAL', line: 3, charStart: 4, charEnd: 30, highlight: 'virtual double area() = 0', description: '⭐ = 0 makes this PURE virtual (abstract)', variables: {} },
            { id: 2, phase: 'ABSTRACT', line: 1, charStart: 0, charEnd: 11, highlight: 'class Shape', description: 'Shape is now ABSTRACT - cannot create Shape objects!', variables: {} },
            { id: 3, phase: 'CONCRETE', line: 6, charStart: 0, charEnd: 26, highlight: 'class Circle : public Shape', description: 'Circle is CONCRETE - implements pure virtual', variables: {} },
            { id: 4, phase: 'IMPLEMENT', line: 10, charStart: 4, charEnd: 51, highlight: 'double area() override { return 3.14 * r * r; }', description: 'Circle provides implementation for area()', variables: {} },
            { id: 5, phase: 'CREATE', line: 14, charStart: 4, charEnd: 29, highlight: 'Shape* s = new Circle(2)', description: 'Create Circle via Shape pointer (r=2)', variables: { s: 'Shape* → Circle(r=2)' } },
            { id: 6, phase: 'CTOR_RUN', line: 9, charStart: 4, charEnd: 32, highlight: 'Circle(double _r) : r(_r) {}', description: 'Circle constructor: r = 2', variables: { r: 2 } },
            { id: 7, phase: 'CALL', line: 15, charStart: 12, charEnd: 22, highlight: 's->area()', description: '🎯 Call area() on Shape pointer', variables: {} },
            { id: 8, phase: 'DISPATCH', line: 10, charStart: 4, charEnd: 51, highlight: 'double area() override { return 3.14 * r * r; }', description: '⚡ Virtual dispatch → Circle::area()', variables: {} },
            { id: 9, phase: 'COMPUTE', line: 10, charStart: 31, charEnd: 46, highlight: '3.14 * r * r', description: 'Calculate: 3.14 × 2 × 2 = 12.56', variables: { r: 2, result: 12.56 } },
            { id: 10, phase: 'OUTPUT', line: 15, charStart: 4, charEnd: 22, highlight: 'cout << s->area()', description: 'Output: 12.56', variables: {}, output: '12.56' },
            { id: 11, phase: 'COMPLETE', line: 16, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Abstract enforces interface; concrete provides behavior', variables: {}, output: '12.56' }
        ]
    },

    // OOP 8: Multiple Inheritance Constructor Order
    {
        id: 'oop-multiple-inheritance',
        title: 'Multiple Inheritance: Constructor Order',
        description: 'Constructors called LEFT to RIGHT in inheritance list',
        difficulty: 'ADVANCED',
        category: 'OOP Inheritance',
...
int main() {
    C obj;
        ...
        steps: [
            { id: 1, phase: 'CLASS_A', line: 1, charStart: 0, charEnd: 7, highlight: 'class A', description: 'First base class: A', variables: {} },
            { id: 2, phase: 'CLASS_B', line: 2, charStart: 0, charEnd: 7, highlight: 'class B', description: 'Second base class: B', variables: {} },
            { id: 3, phase: 'MULTIPLE', line: 3, charStart: 0, charEnd: 26, highlight: 'class C : public A, public B', description: 'C inherits from BOTH A and B (multiple inheritance)', variables: {} },
            { id: 4, phase: 'ORDER', line: 3, charStart: 10, charEnd: 26, highlight: 'public A, public B', description: '📋 Order matters: A listed first, then B', variables: {} },
            { id: 5, phase: 'CREATE', line: 9, charStart: 4, charEnd: 9, highlight: 'C obj', description: '⚡ Create C object - triggers multi-parent constructor chain', variables: {} },
            { id: 6, phase: 'CTOR_A', line: 1, charStart: 18, charEnd: 37, highlight: 'A() { cout << "A "; }', description: '1️⃣ FIRST: A constructor (leftmost base)', variables: {}, output: 'A ' },
            { id: 7, phase: 'CTOR_B', line: 2, charStart: 18, charEnd: 37, highlight: 'B() { cout << "B "; }', description: '2️⃣ SECOND: B constructor (next base)', variables: {}, output: 'A B ' },
            { id: 8, phase: 'CTOR_C', line: 5, charStart: 4, charEnd: 25, highlight: 'C() { cout << "C "; }', description: '3️⃣ THIRD: C constructor (derived)', variables: {}, output: 'A B C ' },
            { id: 9, phase: 'COMPLETE', line: 10, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Multiple inheritance: bases left→right, then derived', variables: {}, output: 'A B C ' }
        ]
    },

    // OOP 9: Diamond Inheritance Problem 
    {
        id: 'oop-diamond-inheritance',
        title: 'Diamond Problem: Virtual Inheritance',
        description: 'Virtual inheritance solves the diamond ambiguity problem',
        difficulty: 'EXPERT',
        category: 'OOP Inheritance',
...
int main() {
    Diamond d;
        ...
        expectedOutput: '111',
        steps: [
            { id: 1, phase: 'BASE', line: 1, charStart: 0, charEnd: 10, highlight: 'class Base', description: 'Common ancestor with x = 1', variables: { x: 1 } },
            { id: 2, phase: 'VIRTUAL_LEFT', line: 3, charStart: 0, charEnd: 30, highlight: 'class Left : virtual public Base', description: '⭐ VIRTUAL inheritance - shares Base with siblings', variables: {} },
            { id: 3, phase: 'VIRTUAL_RIGHT', line: 8, charStart: 0, charEnd: 31, highlight: 'class Right : virtual public Base', description: '⭐ VIRTUAL inheritance - same shared Base', variables: {} },
            { id: 4, phase: 'DIAMOND', line: 13, charStart: 0, charEnd: 38, highlight: 'class Diamond : public Left, public Right', description: 'Diamond inherits both - would be ambiguous without virtual!', variables: {} },
            { id: 5, phase: 'CREATE', line: 19, charStart: 4, charEnd: 13, highlight: 'Diamond d', description: '⚡ Create Diamond - complex constructor chain begins', variables: {} },
            { id: 6, phase: 'VIRTUAL_BASE', line: 1, charStart: 22, charEnd: 27, highlight: 'x = 1', description: '1️⃣ Virtual base (Base) constructed ONCE: x = 1', variables: { x: 1 } },
            { id: 7, phase: 'LEFT_CTOR', line: 5, charStart: 4, charEnd: 19, highlight: 'Left() { x += 10; }', description: '2️⃣ Left constructor: x = 1 + 10 = 11', variables: { x: 11 } },
            { id: 8, phase: 'RIGHT_CTOR', line: 10, charStart: 4, charEnd: 21, highlight: 'Right() { x += 100; }', description: '3️⃣ Right constructor: x = 11 + 100 = 111', variables: { x: 111 } },
            { id: 9, phase: 'DIAMOND_CTOR', line: 15, charStart: 4, charEnd: 25, highlight: 'Diamond() { cout << x; }', description: '4️⃣ Diamond constructor: output x', variables: { x: 111 }, output: '111' },
            { id: 10, phase: 'COMPLETE', line: 20, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Virtual inheritance: ONE shared Base (not 2 copies!)', variables: { x: 111 }, output: '111' }
        ]
    },

    // OOP 10: Static Members
    {
        id: 'oop-static-members',
        title: 'Static Members: Shared Across Objects',
        description: 'Static variables belong to CLASS, not individual objects',
        difficulty: 'INTERMEDIATE',
...
int main() {
    ...
    cout << Counter::count;
        ...
        expectedOutput: '3',
        steps: [
            { id: 1, phase: 'STATIC_DECL', line: 3, charStart: 4, charEnd: 20, highlight: 'static int count', description: '⭐ STATIC: belongs to CLASS, not objects', variables: { 'Counter::count': 0 } },
            { id: 2, phase: 'CTOR', line: 4, charStart: 4, charEnd: 26, highlight: 'Counter() { count++; }', description: 'Constructor increments shared count', variables: {} },
            { id: 3, phase: 'STATIC_INIT', line: 7, charStart: 0, charEnd: 23, highlight: 'int Counter::count = 0', description: 'Static member initialized OUTSIDE class = 0', variables: { 'Counter::count': 0 } },
            { id: 4, phase: 'CREATE_A', line: 10, charStart: 4, charEnd: 13, highlight: 'Counter a', description: '⚡ Create a - constructor runs', variables: {} },
            { id: 5, phase: 'INC_A', line: 4, charStart: 16, charEnd: 24, highlight: 'count++', description: 'count++ → 0 + 1 = 1', variables: { 'Counter::count': 1 } },
            { id: 6, phase: 'CREATE_B', line: 10, charStart: 15, charEnd: 16, highlight: 'b', description: '⚡ Create b - constructor runs', variables: {} },
            { id: 7, phase: 'INC_B', line: 4, charStart: 16, charEnd: 24, highlight: 'count++', description: 'count++ → 1 + 1 = 2', variables: { 'Counter::count': 2 } },
            { id: 8, phase: 'CREATE_C', line: 10, charStart: 18, charEnd: 19, highlight: 'c', description: '⚡ Create c - constructor runs', variables: {} },
            { id: 9, phase: 'INC_C', line: 4, charStart: 16, charEnd: 24, highlight: 'count++', description: 'count++ → 2 + 1 = 3', variables: { 'Counter::count': 3 } },
            { id: 10, phase: 'ACCESS', line: 11, charStart: 12, charEnd: 27, highlight: 'Counter::count', description: 'Access via ClassName::staticMember', variables: { 'Counter::count': 3 } },
            { id: 11, phase: 'OUTPUT', line: 11, charStart: 4, charEnd: 27, highlight: 'cout << Counter::count', description: 'Output: 3', variables: {}, output: '3' },
            { id: 12, phase: 'COMPLETE', line: 12, charStart: 0, charEnd: 1, highlight: '}', description: '✅ Static = shared state across ALL objects', variables: { 'Counter::count': 3 }, output: '3' }
        ]
    },
    ...
    {
        id: 'oop-this-pointer',
        title: 'This Pointer: Self Reference',
        description: 'this points to the current object instance',
        difficulty: 'INTERMEDIATE',
        category: 'OOP Classes',
        code: `class Box {
    int size;
...
int main() {
    Box b(5);
    b.grow(10).grow(5).show();
}`,
        expectedOutput: '20',
        steps: [
            { id: 1, phase: 'MEMBER', line: 2, charStart: 4, charEnd: 13, highlight: 'int size;', description: 'Instance member: size', variables: {} },
            { id: 2, phase: 'PARAM_CONFLICT', line: 4, charStart: 8, charEnd: 16, highlight: 'int size', description: 'Parameter has SAME name as member!', variables: {} },
            { id: 3, phase: 'THIS_USAGE', line: 4, charStart: 20, charEnd: 30, highlight: 'this->size', description: '⭐ this-> distinguishes member from parameter', variables: {} },
            { id: 4, phase: 'CHAINING', line: 7, charStart: 8, charEnd: 21, highlight: 'return *this', description: 'Return *this enables method chaining!', variables: {} },
            { id: 5, phase: 'CREATE', line: 13, charStart: 4, charEnd: 11, highlight: 'Box b(5)', description: 'Create Box with size=5', variables: {} },
            { id: 6, phase: 'CTOR_RUN', line: 4, charStart: 20, charEnd: 36, highlight: 'this->size = size', description: 'this->size (member) = size (param=5)', variables: { size: 5 } },
            { id: 7, phase: 'CHAIN1', line: 14, charStart: 4, charEnd: 14, highlight: 'b.grow(10)', description: 'First grow: size += 10', variables: {} },
            { id: 8, phase: 'GROW1', line: 6, charStart: 8, charEnd: 24, highlight: 'this->size += n', description: 'size = 5 + 10 = 15', variables: { size: 15 } },
            { id: 9, phase: 'RETURN1', line: 7, charStart: 8, charEnd: 21, highlight: 'return *this', description: 'Return self → enables chaining', variables: {} },
            { id: 10, phase: 'CHAIN2', line: 14, charStart: 15, charEnd: 23, highlight: '.grow(5)', description: 'Chained grow: size += 5', variables: {} },
            { id: 11, phase: 'GROW2', line: 6, charStart: 8, charEnd: 24, highlight: 'this->size += n', description: 'size = 15 + 5 = 20', variables: { size: 20 } },
            { id: 12, phase: 'SHOW', line: 14, charStart: 24, charEnd: 31, highlight: '.show()', description: 'Output size', variables: { size: 20 }, output: '20' },
            { id: 13, phase: 'COMPLETE', line: 15, charStart: 0, charEnd: 1, highlight: '}', description: '✅ this enables self-reference and method chaining', variables: {}, output: '20' }
        ]
    },

    // OOP 12: Complex Multi-Level with Polymorphism
    {
        id: 'oop-complex-chain',
        title: 'Complex: 4-Level Inheritance + Polymorphism',
        description: 'Deep inheritance chain with virtual method override at each level',
        difficulty: 'EXPERT',
        category: 'OOP Polymorphism',
        code: `class Entity { 
public: 
    Entity() { cout << "E"; }
    virtual void act() { cout << "e"; } 
};
class Living : public Entity { 
public: 
    Living() { cout << "L"; }
    void act() override { cout << "l"; } 
};
class Animal : public Living { 
public: 
    Animal() { cout << "A"; }
    void act() override { cout << "a"; } 
};
class Dog : public Animal { 
public: 
    Dog() { cout << "D"; }
    void act() override { cout << "d"; } 
};
...
int main() {
    ...
    e->act();
        ...
        expectedOutput: 'ELADd',
        steps: [
            { id: 1, phase: 'HIERARCHY', line: 1, charStart: 0, charEnd: 12, highlight: 'class Entity', description: 'Level 1: Entity (base)', variables: {} },
            { id: 2, phase: 'HIERARCHY', line: 6, charStart: 0, charEnd: 28, highlight: 'class Living : public Entity', description: 'Level 2: Living extends Entity', variables: {} },
            { id: 3, phase: 'HIERARCHY', line: 11, charStart: 0, charEnd: 29, highlight: 'class Animal : public Living', description: 'Level 3: Animal extends Living', variables: {} },
            { id: 4, phase: 'HIERARCHY', line: 16, charStart: 0, charEnd: 26, highlight: 'class Dog : public Animal', description: 'Level 4: Dog extends Animal', variables: {} },
            { id: 5, phase: 'VIRTUAL', line: 4, charStart: 4, charEnd: 20, highlight: 'virtual void act()', description: '⭐ Virtual at base → polymorphic dispatch', variables: {} },
            { id: 6, phase: 'POINTER', line: 22, charStart: 4, charEnd: 27, highlight: 'Entity* e = new Dog()', description: 'Base pointer to most derived (Dog)', variables: {} },
            { id: 7, phase: 'CTOR_1', line: 3, charStart: 4, charEnd: 30, highlight: 'Entity() { cout << "E"; }', description: '1️⃣ Entity constructor: "E"', variables: {}, output: 'E' },
            { id: 8, phase: 'CTOR_2', line: 8, charStart: 4, charEnd: 30, highlight: 'Living() { cout << "L"; }', description: '2️⃣ Living constructor: "L"', variables: {}, output: 'EL' },
            { id: 9, phase: 'CTOR_3', line: 13, charStart: 4, charEnd: 30, highlight: 'Animal() { cout << "A"; }', description: '3️⃣ Animal constructor: "A"', variables: {}, output: 'ELA' },
            { id: 10, phase: 'CTOR_4', line: 18, charStart: 4, charEnd: 27, highlight: 'Dog() { cout << "D"; }', description: '4️⃣ Dog constructor: "D"', variables: {}, output: 'ELAD' },
            { id: 11, phase: 'CALL', line: 23, charStart: 4, charEnd: 13, highlight: 'e->act()', description: '🎯 Call act() on Entity pointer...', variables: {} },
            { id: 12, phase: 'DISPATCH', line: 19, charStart: 4, charEnd: 40, highlight: 'void act() override { cout << "d"; }', description: '⚡ Virtual dispatch → Dog::act() (most derived)', variables: {} },
            { id: 13, phase: 'EXECUTE', line: 19, charStart: 26, charEnd: 36, highlight: 'cout << "d"', description: 'Dog version: "d"', variables: {}, output: 'ELADd' },
            { id: 14, phase: 'COMPLETE', line: 24, charStart: 0, charEnd: 1, highlight: '}', description: '✅ 4-level chain: construct top→down, dispatch to bottom', variables: {}, output: 'ELADd' }
        ]
    }
];
